...
public class SocketClient implements Client {
    ...
    public void connect() {
        try {
            ...
            this.mSocket.connect(mAddress,2000);
            this.isConnecting = false;

            this.isConnected = true;
            this.isDisconnected = false;
            Log.d("DEBUG","=========连接成功=========="+mAddress.getHostName()+":"+mAddress.getPort());
        } catch (IOException e) {
//            e.printStackTrace();
            this.isConnected = false;
            this.isDisconnected = true;
            Log.d("DEBUG","=========连接失败=========="+mAddress.getHostName()+":"+mAddress.getPort()+":"+e.getMessage());
        }
    }
...
//                    e.printStackTrace();
            ...
            Log.d(TAG,"=========断开连接=========="+mAddress.getHostName()+":"+mAddress.getPort());
