...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    // 数据库名称
    public static final String DATABASE_NAME = "pacmessage.db";
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            ...
            TableUtils.createTable(connectionSource, FrendBean.class);
            TableUtils.createTable(connectionSource, MessageLockBean.class);
    ...
    public void onUpgrade(SQLiteDatabase database, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        try {
            if (1 < newVersion) {
                ...
                TableUtils.dropTable(connectionSource, MessageLockBean.class, true);
